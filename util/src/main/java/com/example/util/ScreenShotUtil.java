...
public class ScreenShotUtil {
    ...
    private final String TAG = "MY_SCREEN";

    public ScreenShotUtil(Activity context) {
    ...
    private void handleMediaRowData(String data, long dateTaken) {
        ...
        if (checkScreenShot(data, dateTaken)) {
            ...
            if (catchScreenShotListener != null) {
                catchScreenShotListener.screenShotData(data);
            }
        } else {
    ...
    public interface CatchScreenShotListener {
        /**
         * 返回截图路径
         *
         * @param data
         */
        void screenShotData(String data);
    }

    private CatchScreenShotListener catchScreenShotListener;

    public void setCatchScreenShotListener(CatchScreenShotListener l) {
        this.catchScreenShotListener = l;
    }
